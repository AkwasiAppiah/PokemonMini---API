...
{
    public class YodaHTTPClientHelper : IYodaHTTPClientHelper
    {
        IHttpClientFactory httpClientFactory;
        HttpClient client;
        String ClientName;

        public YodaHTTPClientHelper(IHttpClientFactory httpClientFactory, string ClientName)
        {
        ...
        {
            T data;
            //string url = "https://api.funtranslations.com/translate/yoda";
            client = httpClientFactory.CreateClient(ClientName);
